...
namespace TechNova_IT_Solutions.Pages.ChiefComplianceManager
{
    public class ComplianceReportsModel : PageModel
    {
        ...
        // Chief CM always sees all branches — callerBranchId is always null
        private readonly int? _callerBranchId = null;
        ...
        private IActionResult? RequireAuthorizedReportUser()
        {
            ...
            GeneratedByRole = userRole ?? RoleNames.ChiefComplianceManager;

            // Chief CM always sees all branches — no branch scoping
            // _callerBranchId remains null
