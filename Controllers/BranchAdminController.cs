...
namespace TechNova_IT_Solutions.Controllers
{
    public class BranchAdminController : Controller
    {
        ...
        {
            var denied = RoleAccess.RequireRoleOrAccessDenied(this, RoleNames.BranchAdmin, RoleNames.SuperAdmin);
            ...
            return View("~/Pages/BranchAdmin/PolicyArchives.cshtml", model);
        }
    }
}
